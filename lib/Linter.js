...
class Linter extends EventEmitter {
    ...
    verify(textOrSourceCode, config, filenameOrOptions, saveState) {
        ...
        if (ast) {
            ...
            if (allowInlineConfig !== false) {
                config = modifyConfigsFromComments(this.currentFilename, ast, config, this.reportingConfig, this.messages);
            }
            ...
            addDeclaredGlobals(ast, this.currentScopes[0], this.currentConfig);
     ...
     * @returns {void}
     */
    defineRule(ruleId, ruleModule) { // eslint-disable-line class-methods-use-this
     ...
     */
    getRules() { // eslint-disable-line class-methods-use-this
